...
set CLASSPATH=%APP_HOME%\lib\Accounts.jar

@rem Execute Accounts
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %ACCOUNTS_OPTS%  -classpath "%CLASSPATH%" ru.eltex.Main %CMD_LINE_ARGS%
...
if  not "" == "%ACCOUNTS_EXIT_CONSOLE%" exit 1
exit /b 1
